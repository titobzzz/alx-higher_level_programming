...
class test_rectangle(unittest.TestCase):
    ...
    def test_display_square_size_zero(self):
        '''Checking out the stdout output by capturing it
        '''
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        r1 = Rectangle(3, 7)
...
class TestRectangle(unittest.TestCase):
    ...
    def test_func_docstrings(self):
        """  This..    Tests if methods docstring documntation exist
        """
    ...
    def test_inputted_types(self):
        """For the different types for inputted arguments
        """
        with self.assertRaises(TypeError):
...
class TestRectangle_height(unittest.TestCase):
    """Tesing the initialization of Rectangle height attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """ 
    tests initialization of Rectangle y attribute."""
...
class TestRectangle_area(unittest.TestCase):
    """ The testing for the area method of the Rectangle class."""
...
class TestRectangle_stdout(unittest.TestCase):
    """
    Testing the __str__ and display methods of Rectangle class."""
...
class TestRectangle_update_args(unittest.TestCase):
    """
    This Unittests are for testing update args method of the Rectangle class."""
