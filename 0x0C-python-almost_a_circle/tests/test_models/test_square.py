...
class test_square(unittest.TestCase):
    ...
    def test_display_square_size_one(self):
        '''
            This Checks the stdout output by capturing it
        '''
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        r1 = Square(1)
    ...
    def test_display_square(self):
        '''
           This  Checs the stdout output by capturing it
        '''
        capturedOutput = StringIO()
        sys.stdout = capturedOutput
        r1 = Square(10)
...
class TestSquare(unittest.TestCase):
    ...
    def test_12_1(self):
        """
        Testing for update method on Square with wrong types.
        """
    ...
    def test_14_0(self):
        """
        Testing for public method to_dictionary
        ."""
