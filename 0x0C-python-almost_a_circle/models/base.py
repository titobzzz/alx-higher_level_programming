...
class Base:
    ...
    def save_to_file(cls, list_objs):
        """this
        saves the JSON representation to file"""
    ...
    def load_from_file_csv(cls):
        """
        this Deserializes the CSV format from a file
        """
    ...
    def draw(list_rectangles, list_squares):
        """
        To draw Rectangles and Squares using the turtle module.
        Args:
